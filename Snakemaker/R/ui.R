    ...
    div(
      ...
      fluidPage(
        ...
        div(class = "action-buttons",
            ...
            actionButton("toggle_importance_btn", span(icon("star"), " Toggle importance"), class = "btn btn-secondary"),
        ...
        div(class = "archived-rules",
            selectInput("archived_rules_select", "Select an archived rule:",
                        ...
                        selectize = FALSE,
                        multiple = TRUE,  # Allow multiple selection for removal
                        size = 5,
                        width = "100%"),
            div(class = "action-buttons",
                actionButton("parse_again", span(icon("redo"), " Parse Again"), class = "btn btn-success"),
                actionButton("remove_archived", span(icon("trash"), " Remove"), class = "btn btn-danger")
            )
        ),
      )
    )
